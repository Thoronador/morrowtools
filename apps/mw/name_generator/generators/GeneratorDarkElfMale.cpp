...
std::vector<std::string> GeneratorDarkElfMale::generate(const uint_least16_t n)
{
  ...
  auto result = generate_ashlanders(ashlander_count, false);
  const auto part2 = generate_non_ashlanders(n - ashlander_count, false);
