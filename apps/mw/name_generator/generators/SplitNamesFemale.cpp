...
SplitNamesFemale::SplitNamesFemale()
: first_names({ }),
  last_names({ })
{
}

std::vector<std::string> SplitNamesFemale::generate(const uint_least16_t n, const std::string& raceId)
{
...
void SplitNamesFemale::prepare(const std::string& raceId)
{
