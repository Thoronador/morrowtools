...
#ifndef MW_NAMEGEN_GENERATOR_WHOLE_NAMES_BOTH_HPP
#define MW_NAMEGEN_GENERATOR_WHOLE_NAMES_BOTH_HPP
...
class WholeNamesBoth
{
  public:
    WholeNamesBoth();

    virtual ~WholeNamesBoth() = default;
...
#endif // MW_NAMEGEN_GENERATOR_WHOLE_NAMES_BOTH_HPP
