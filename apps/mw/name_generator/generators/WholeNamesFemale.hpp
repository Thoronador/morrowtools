...
#ifndef MW_NAMEGEN_GENERATOR_WHOLE_NAMES_FEMALE_HPP
#define MW_NAMEGEN_GENERATOR_WHOLE_NAMES_FEMALE_HPP
...
class WholeNamesFemale
{
  public:
    WholeNamesFemale();

    virtual ~WholeNamesFemale() = default;
...
#endif // MW_NAMEGEN_GENERATOR_WHOLE_NAMES_FEMALE_HPP
