...
WholeNamesMale::WholeNamesMale()
: names({ })
{
}

std::vector<std::string> WholeNamesMale::generate(const uint_least16_t n, const std::string& raceId)
{
  if (names.empty())
  {
    prepare(raceId);
...
void WholeNamesMale::prepare(const std::string& raceId)
{
