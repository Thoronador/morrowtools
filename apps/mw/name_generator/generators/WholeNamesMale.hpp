...
#ifndef MW_NAMEGEN_GENERATOR_WHOLE_NAMES_MALE_HPP
#define MW_NAMEGEN_GENERATOR_WHOLE_NAMES_MALE_HPP
...
class WholeNamesMale
{
  public:
    WholeNamesMale();

    virtual ~WholeNamesMale() = default;
...
#endif // MW_NAMEGEN_GENERATOR_WHOLE_NAMES_MALE_HPP
