...
#ifndef SRTP_LZ4DEFRAME_FUNCTIONS_HPP
#define SRTP_LZ4DEFRAME_FUNCTIONS_HPP
...
/** \brief Performs lz4 decompression (lz4 frame API).
 *
...
#endif // SRTP_LZ4DEFRAME_FUNCTIONS_HPP
