...
#include "ShaderParticleGeometryRecord.hpp"
#include <iostream>
#include <cstring>
...
bool ShaderParticleGeometryRecord::saveToStream(std::ostream& output) const
{
...
bool ShaderParticleGeometryRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
