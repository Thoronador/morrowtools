...
#ifndef SR_WORDOFPOWERRECORD_HPP
#define SR_WORDOFPOWERRECORD_HPP
...
/** Holds information about a Word of Power. */
struct WordOfPowerRecord: public BasicRecord
{
  public:
     ...
     *
     * \param other   the other WordOfPowerRecord to compare with
    ...
    LocalizedString translated; // sub record TNAM
}; // struct

} // namespace

#endif // SR_WORDOFPOWERRECORD_HPP
