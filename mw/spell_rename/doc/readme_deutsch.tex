...
gemacht. Das Programm ist nicht vollendet und kann daher Fehler (,,Bugs``) enthalten.
Aus den genannten Gr\"{u}nden wird es unter dieser Lizenz ,,so wie es ist``
ohne jegliche Gew\"{a}hrleistung zur Verf\"{u}gung gestellt. Dies gilt unter anderem
-- aber nicht ausschlie\ss{}lich -- f\"{u}r Verwendbarkeit f\"{u}r einen bestimmten Zweck,
