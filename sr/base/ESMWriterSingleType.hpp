...
#ifndef SR_ESMWRITERSINGLETYPE_HPP
#define SR_ESMWRITERSINGLETYPE_HPP
...
bool ESMWriterSingleType<recT, singleT>::writeGroups(std::ofstream& output) const
{
  ...
  recT dummyRec;
  headerData.setLabel(dummyRec.getRecordType());
  headerData.setType(GroupData::cTopLevelGroup);
  // -- calculate size
  uint32_t total = 0;
...
#endif // SR_ESMWRITERSINGLETYPE_HPP
