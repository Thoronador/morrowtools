...
const int32_t cALCA = 0x41434C41; //"ALCA" = 41 4C 43 41
const int32_t cALCL = 0x4C434C41; //"ALCL" = 41 4C 43 4C
const int32_t cALCO = 0x4F434C41; //"ALCO" = 41 4C 43 4F
const int32_t cALDN = 0x4E444C41; //"ALDN" = 41 4C 44 4E
const int32_t cALEA = 0x41454C41; //"ALEA" = 41 4C 45 41
const int32_t cALED = 0x44454C41; //"ALED" = 41 4C 45 44
const int32_t cALEQ = 0x51454C41; //"ALEQ" = 41 4C 45 51
const int32_t cALFA = 0x41464C41; //"ALFA" = 41 4C 46 41
const int32_t cALFC = 0x43464C41; //"ALFC" = 41 4C 46 43
const int32_t cALFD = 0x44464C41; //"ALFD" = 41 4C 46 44
const int32_t cALFE = 0x45464C41; //"ALFE" = 41 4C 46 45
const int32_t cALFI = 0x49464C41; //"ALFI" = 41 4C 46 49
const int32_t cALFL = 0x4C464C41; //"ALFL" = 41 4C 46 4C
const int32_t cALFR = 0x52464C41; //"ALFR" = 41 4C 46 52
const int32_t cALID = 0x44494C41; //"ALID" = 41 4C 49 44
const int32_t cALLS = 0x534C4C41; //"ALLS" = 41 4C 4C 53
const int32_t cALNA = 0x414E4C41; //"ALNA" = 41 4C 4E 41
const int32_t cALNT = 0x544E4C41; //"ALNT" = 41 4C 4E 54
const int32_t cALPC = 0x43504C41; //"ALPC" = 41 4C 50 43
const int32_t cALRT = 0x54524C41; //"ALRT" = 41 4C 52 54
const int32_t cALSP = 0x50534C41; //"ALSP" = 41 4C 53 50
const int32_t cALST = 0x54534C41; //"ALST" = 41 4C 53 54
const int32_t cALUA = 0x41554C41; //"ALUA" = 41 4C 55 41
...
const int32_t cATKD = 0x444B5441; //"ATKD" = 41 54 4B 44
const int32_t cATKE = 0x454B5441; //"ATKE" = 41 54 4B 45
...
const int32_t cCSDT = 0x54445343; //"CSDT" = 43 53 44 54
...
const int32_t cDOFT = 0x54464F44; //"DOFT" = 44 4F 46 54
...
const int32_t cFTST = 0x54535446; //"FTST" = 46 54 53 54
...
const int32_t cHCLF = 0x464C4348; //"HCLF" = 48 43 4C 46
...
const int32_t cLTMP = 0x504D544C; //"LTMP" = 4C 54 4D 50
...
const int32_t cOFST = 0x5453464F; //"OFST" = 4F 46 53 54
...
const int32_t cQSTA = 0x41545351; //"QSTA" = 51 53 54 41
const int32_t cQTGL = 0x4C475451; //"QTGL" = 51 54 47 4C
...
const int32_t cSHRT = 0x54524853; //"SHRT" = 53 48 52 54
...
const int32_t cTINI = 0x494E4954; //"TINI" = 54 49 4E 49
const int32_t cTINV = 0x564E4954; //"TINV" = 54 49 4E 56
