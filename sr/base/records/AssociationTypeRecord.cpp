...
bool AssociationTypeRecord::saveToStream(std::ostream& output) const
{
...
bool AssociationTypeRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
