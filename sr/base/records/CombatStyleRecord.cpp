...
bool CombatStyleRecord::saveToStream(std::ostream& output) const
{
...
bool CombatStyleRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
