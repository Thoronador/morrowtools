...
bool DialogueRecord::saveToStream(std::ofstream& output) const
{
...
bool DialogueRecord::loadFromStream(std::ifstream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
