...
#include "EquipmentSlotRecord.hpp"
#include <iostream>
#include <cstring>
...
: BasicRecord(), editorID(""),
  parentSlots(std::vector<uint32_t>()),
  flags(0)
{
...
bool EquipmentSlotRecord::saveToStream(std::ostream& output) const
{
...
bool EquipmentSlotRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
...
uint32_t EquipmentSlotRecord::getRecordType() const
{
  return cEQUP;
}
