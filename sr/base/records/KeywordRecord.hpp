...
/** Holds information about a "keyword", i. e. a marker. */
struct KeywordRecord: public BasicRecord
{
  public:
     ...
     */
    bool equals(const KeywordRecord& other) const;
    #endif
