...
#include "LeveledSpellRecord.hpp"
#include <cstring>
#include <iostream>
...
: LeveledListBaseRecord(), editorID("")
{
...
bool LeveledSpellRecord::saveToStream(std::ostream& output) const
{
...
bool LeveledSpellRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
