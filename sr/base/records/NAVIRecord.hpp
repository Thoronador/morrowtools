...
#ifndef SR_NAVIRECORD_HPP
#define SR_NAVIRECORD_HPP
...
/** Holds some unknown data related to AI navigation. */
struct NAVIRecord: public BasicRecord
{
  public:
     ...
     */
    bool equals(const NAVIRecord& other) const;
    #endif
