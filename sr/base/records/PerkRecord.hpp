...
/** Holds information about a perk. */
struct PerkRecord: public BasicRecord
{
  public:
    ...
    std::string editorID; /**< ID of the perk in the editor */
    LocalizedString name; /**< name of the perk, subrecord FULL */
    LocalizedString description; /**< name of the perk, subrecord DESC */
    std::vector<SubBlock> subBlocks; /**< various other subrecords of the PerkRecord */
}; // struct

} // namespace

#endif // SR_PERKRECORD_HPP
