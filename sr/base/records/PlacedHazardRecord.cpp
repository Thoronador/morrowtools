...
#include "PlacedHazardRecord.hpp"
#include <cstring>
#include <iostream>
...
bool PlacedHazardRecord::saveToStream(std::ostream& output) const
{
...
bool PlacedHazardRecord::loadFromStream(std::istream& in_File, const bool localized, const StringTable& table)
{
  uint32_t readSize = 0;
