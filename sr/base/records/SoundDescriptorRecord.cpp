...
#include "SoundDescriptorRecord.h"
#include <iostream>
...
: BasicRecord()
{
  ...
  waveFiles.clear(); //subrecords ANAM
  outputModelFormID = 0; //subrecord ONAM
  hasFNAM = false;
  unknownFNAM = 0;
  conditions.clear(); //subrecords CTDA
  hasLNAM = false;
  unknownLNAM = 0;
  //subrecord BNAM
...
bool SoundDescriptorRecord::loadFromStream(std::ifstream& in_File)
{
  uint32_t readSize = 0;
