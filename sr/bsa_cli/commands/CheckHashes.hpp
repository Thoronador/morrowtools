...
#ifndef SRTP_BSACLI_COMMAND_CHECKHASHES_HPP
#define SRTP_BSACLI_COMMAND_CHECKHASHES_HPP
...
class CheckHashes: public Command
{
  public:
    CheckHashes();
    ...
    /** \brief Checks hashes of the files and directories in the BSA.
     *
     * \return Returns zero in case of success.
     *         Returns a non-zero exit code in case of failure.
     * \remark The return value can be used as exit code of the main() function.
...
#endif // SRTP_BSACLI_COMMAND_CHECKHASHES_HPP
