...
#ifndef SRTP_BSACLI_COMMAND_DIRECTORY_METADATA_HPP
#define SRTP_BSACLI_COMMAND_DIRECTORY_METADATA_HPP
...
class DirectoryMetadata: public Command
{
  public:
    DirectoryMetadata();
    ...
    /** \brief Shows metadata of the directories in the BSA.
     *
     * \return Returns zero in case of success.
     *         Returns a non-zero exit code in case of failure.
     * \remark The return value can be used as exit code of the main() function.
...
#endif // SRTP_BSACLI_COMMAND_DIRECTORY_METADATA_HPP
