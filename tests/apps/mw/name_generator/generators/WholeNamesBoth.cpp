...
#include "../../../../../apps/mw/name_generator/generators/WholeNamesBoth.hpp"

TEST_CASE("MWTP::WholeNamesBoth")
{
  ...
  SECTION("generate")
  {
    ...
    WholeNamesBoth generator;
    const auto names = generator.generate(30, "SomeTestId");
    ...
    // Names "Jane" and "John" should be present.
