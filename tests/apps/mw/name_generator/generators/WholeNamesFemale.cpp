...
#include "../../../../../apps/mw/name_generator/generators/WholeNamesFemale.hpp"

TEST_CASE("MWTP::WholeNamesFemale")
{
  ...
  SECTION("generate")
  {
    ...
    WholeNamesFemale generator;
    const auto names = generator.generate(5, "SomeTestId");
    ...
    // Name "John" should not be present due to different gender.
    REQUIRE( std::find(names.begin(), names.end(), "John") == names.end() );
    // Names "Jane" should be present.
