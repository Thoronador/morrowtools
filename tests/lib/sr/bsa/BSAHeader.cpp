...
#include "../../../../lib/sr/bsa/BSAHeader.hpp"
...
TEST_CASE("BSAHeader")
{
  ...
  SECTION("hasEmbeddedFileNames")
  {
    BSAHeader header;

    header.archiveFlags = 0;
    REQUIRE_FALSE( header.hasEmbeddedFileNames() );

    header.archiveFlags = 256;
    REQUIRE( header.hasEmbeddedFileNames() );
