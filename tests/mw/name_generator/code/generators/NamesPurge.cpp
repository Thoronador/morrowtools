...
#include "../../../../../apps/mw/name_generator/generators/NordNamesPurge.hpp"
#include "../../../../../apps/mw/name_generator/generators/OrcNamesPurge.hpp"
...
TEST_CASE("MWTP name_generator: NamesPurge")
{
  ...
  SECTION("HighElfNamesPurge")
  {
    PurgeGenerator<HighElfNamesPurge> instance;
    REQUIRE_FALSE( instance.purge().empty() );
  }
  ...
  SECTION("NordNamesPurge")
  {
    PurgeGenerator<NordNamesPurge> instance;
    REQUIRE_FALSE( instance.purge().empty() );
  }

  SECTION("OrcNamesPurge")
  {
    PurgeGenerator<OrcNamesPurge> instance;
    REQUIRE_FALSE( instance.purge().empty() );
  }
